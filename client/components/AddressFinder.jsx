  ...
  render () {
    return (
      <form className='formBox mb-10' method="get">
        ...
        <input type="search" id='address_line_1' className='formInput rounded-md shadow-sm col-1 h-12' placeholder="search address" ref={this.address_line_1}></input>
        ...
        <input className='btn m-10 cursor-pointer object-center bg-black hover:bg-gray-900 text-white font-bold rounded-md items-center justify-center col-1 h-8 mt-4 w-20' type="submit" name="next"></input>
      </form>
    )
  }
}
