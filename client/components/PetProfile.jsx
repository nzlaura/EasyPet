...
import PetProfileBackground from '../../server/public/ImageAssets/AnimationTwo/GroupTwo.png'
...
function PetProfile (props) {
  ...
  return (
    <>
      <div className='bg-contain bg-center bg-no-repeat bg-scroll mb-20' style={{ backgroundImage: `url(${PetProfileBackground})` }}>
        <div className='container h-screen inline'>
          <p className='text-5xl items-left font-bold mb-5 mt-12 ml-20 text-black'>Your Pets</p>
          <form className='flex items-center grid grid-cols-1 w-4/12 ml-20' id='profile-form'>
            <p className='text-2xl items-left font-bold text-white'>View/Add Pet</p>
