      ...
      <div className='bg-scroll bg-cover' style={{ backgroundImage: `url(${signInImage})` }}>
        <div className='container h-screen'>
          <form className='flex items-center grid grid-cols-1 grid-rows-6 w-3/12 h-64' id='signin-form'>
            ...
            <input className='rounded-md shadow-sm col-1 mt-52 ml-20 mb-10 h-12 p-4' type='text' id='username' name='username' placeholder='Enter Username' onChange={(e) => setLoginUsername(e.target.value)}/>
            <input className='rounded-md shadow-sm col-1 mt-56 ml-20 h-12 p-4' type='password' id='passwordinput' name='passwordinput' placeholder='Enter Password' onChange={(e) => setLoginPassword(e.target.value)}/>
