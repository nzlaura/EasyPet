...
function TermsOfService () {
    ...
    <>
        <div className='container'>
            <p className='text-5xl flex text-left font-bold mt-36 mb-4 ml-36'>EasyPet General Terms and Conditions</p>
        </div>

        <div className='container mt-8 mb-32 ml-36 w-8/12'>
            <p>
            These general terms and conditions apply to all users (‘You’) of the EasyPet Limited (‘we’, ‘us’) website and mobile application (‘App’ or ‘Apps’) (together the ‘Platforms’). By viewing and using the Platforms you are deemed to agree to these terms and conditions without qualification. If you do not agree to be bound by these terms and conditions, you must stop accessing and using the Platforms.
            <br></br>
            <br></br>
            The Platforms are operated by EasyPetLimited from New Zealand. The information on the Platforms may not be appropriate or available for use in other jurisdictions. If you choose to access the Platforms from a jurisdiction other than New Zealand, you do so on your own initiative and you are responsible for compliance with any applicable laws of that jurisdiction.
            <br></br>
            <br></br>
            Privacy policy and personal information:<br></br>
            Information collected through the Platforms may include your personal information, and you agree to the terms of our privacy policy [www.easypet.co.nz/privacypolicy].
            <br></br><br></br>
            ...
            <br></br><br></br>
            Registration and accounts:<br></br>
            When you complete a registration in relation to the Platforms it will as an animal owner.
            <br></br><br></br>
            Where you complete a registration in relation to the Platforms:<br></br>
            <br></br>
            ...
            <br></br><br></br>
            Links to our Platforms and Framing:<br></br>
            ...
            <br></br><br></br>
            Change to terms and conditions:<br></br>
            ...
            <br></br><br></br>
            No Relationship:<br></br>
            hese terms and conditions will not be deemed to create a partnership, joint venture, agency or employment relationship of any kind between us and you.
            <br></br><br></br>
            General:<br></br>
            ...
            <br></br>
            These terms of service were last updated on 20th July, 2021.<br></br>
            </p>
        </div>
    </>
  )
