      ...
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-emerald-500 mb-3 ml-96 w-4/6">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between ml-96 w-4/6">
          ...
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <button
              className="hover:text-green-500 text-black cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-transparent rounded bg-transparent block lg:hidden outline-none focus:outline-none"
              type="button"
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <IfAuthenticated>
                ...
                <li className="nav-item">
                  <a className="hover:text-white px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75"
                    href="#/user/pets">
                    <span className="ml-2">My Pets</span>
                  </a>
                </li>
