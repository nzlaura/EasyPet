    ...
    <>
      <div className='bg-scroll bg-cover' style={{ backgroundImage: `url(${profileImage})` }}>
        <div className='container h-screen inline'>
          ...
          <form className='flex items-center grid grid-cols-1 grid-rows-2 w-3/12 h-64' id='profile-form'>
            <label className='ml-20' htmlFor='username'>Username</label>
            <input className='rounded-md shadow-sm col-1 h-12 ml-20 p-4' type='text' id='username'placeholder='Enter Username' name='username' onChange={handleChange}/>
            <label className='ml-20' htmlFor='email'>Email</label>
            <input className='rounded-md shadow-sm col-1 h-12 ml-20 p-4' type='text' id='email' name='email' placeholder='Enter Email Address' onChange={handleChange}/>
            <label className='ml-20' htmlFor='phone'>Phone Number</label>
            <input className='rounded-md shadow-sm col-1 h-12 ml-20 p-4' type='int' id='phone' name='phone' placeholder='Enter Phone Number' onChange={handleChange}/>
            ...
            <input className='rounded-md shadow-sm col-1 h-12 ml-20 p-4' type='text' id='firstName' name='firstname' placeholder='Enter First Name' onChange={handleChange}/>
            <label className='ml-20'>Last Name</label>
            <input className='rounded-md shadow-sm col-1 h-12 ml-20 p-4' type='text' id='lastName' name='lastname' placeholder='Enter Last Name' onChange={handleChange}/>
            <label className='ml-20'>Date of Birth</label>
            <input className='rounded-md shadow-sm col-1 h-12 ml-20 p-4' type='date' id='dob' name='dob' placeholder='Enter DOB' onChange={handleChange}/>
            <AddressFinder/>
          </form>
        </div>
