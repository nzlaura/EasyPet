    ...
    <>
      ...
      <div className='container grid grid-cols-2 mb-12'>
        ...
        <div>
          ...
          <p className='text-3xl col-2 flex text-left ml-36 mb-12'>Log in to your account, and visit the my pets page. Add a few details about your pet and hit the submit button.
