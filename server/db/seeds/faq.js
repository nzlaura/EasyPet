  ...
  return knex('faq').del()
    .then(function () {
      return knex('faq').insert([
        ...
        { id: 2, question: 'Is this going to create more work for me?', answer: 'We hope not! EasyPet is designed to simply and streamline your pet care needs.' },
        { id: 3, question: 'How do I sign up to EasyPet?', answer: '<a href="#/register">Click here</a> to begin the signup process' },
        ...
        { id: 6, question: 'How do I contact the team at EasyPet', answer: 'We would love to hear from you! The best way to contact us is <a href="#/contact">here.</a>' }
      ])
    })
}
